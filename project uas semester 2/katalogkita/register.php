              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Registrasi Akun</h1><h2>- KATALOGKITA -</h2>
                  </div>
                  <form class="user" method="post" action="simpan_datapelanggan.php">

                    <div class="form-group">
                      <input type="text" name="nama" class="form-control form-control-user" placeholder="Masukkan Nama Anda">
                    </div>
                    ...
                    <div class="form-group">
                      <input type="text" name="email" class="form-control form-control-user" placeholder="masukkan E-Mail Anda">
                    </div>
